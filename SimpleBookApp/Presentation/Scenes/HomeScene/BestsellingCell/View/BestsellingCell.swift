...
class BestsellingCell: UITableViewCell {
    ...
    @IBOutlet weak var bestsellingLabel: UILabel!
    ...
    private func configureDataSource() {
        ...
        dataSource = CellDataSource(with: collectionView, books: books, viewModel: viewModel, cellToDeque: BestsellingItemCell.self)
    }
...
extension BestsellingCell: UICollectionViewDelegateFlowLayout {
